<?php
// view-employee.php (TEK-C style) - shows full employee details
session_start();
 ...
 * uploads/employees/photos/photo_....png
 */
...
<head>
  ...
  <style>
    ...
    .btn-download:hover{ background:#f9fafb; color: var(--blue); border-color: rgba(45,156,219,.25); }
          ...
          <div class="d-flex gap-2">
            ...
            <a href="manage-employees.php" class="btn-back">
              <i class="bi bi-arrow-left"></i> Back
                 ...
                 <a href="download-employee-pdf.php?id=<?php echo (int)$emp['id']; ?>" 
     ...
     <i class="bi bi-download me-1"></i> Download PDF
        ...
        <?php if ($emp): ?>
          ...
          <div class="section-card">
            ...
            <div class="kv">
              <div class="kv-row"><div class="kv-k">Employee ID</div><div class="kv-v"><?php echo showVal($emp['id']); ?></div></div>
              ...
              <div class="kv-row"><div class="kv-k">Mobile Number</div><div class="kv-v"><?php echo showVal($emp['mobile_number']); ?></div></div>
          ...
          <div class="section-card">
            <div class="section-head">
              <div class="left">
                <div class="sec-ic"><i class="bi bi-telephone-plus"></i></div>
                <div>
                  <p class="sec-title mb-0">Emergency Contact</p>
                  <p class="sec-sub">Primary emergency person details</p>
                </div>
              </div>
            </div>
            <div class="kv">
          ...
          <div class="section-card">
            <div class="section-head">
              <div class="left">
                ...
                <div>
                  <p class="sec-title mb-0">Employment Details</p>
                  <p class="sec-sub">Joining, department, role and reporting</p>
                </div>
              </div>
            </div>
            <div class="kv">
              ...
              <div class="kv-row"><div class="kv-k">Employee Status</div><div class="kv-v"><?php echo showVal($emp['employee_status']); ?></div></div>
            </div>
          </div>
          ...
          <div class="section-card">
            <div class="section-head">
              <div class="left">
                <div class="sec-ic"><i class="bi bi-shield-lock"></i></div>
                <div>
                  <p class="sec-title mb-0">Account Details</p>
                  <p class="sec-sub">Username and system information</p>
                </div>
              </div>
            </div>
            <div class="kv">
              <div class="kv-row"><div class="kv-k">Username</div><div class="kv-v"><?php echo showVal($emp['username']); ?></div></div>
              <div class="kv-row"><div class="kv-k">Password</div><div class="kv-v">Hidden</div></div>
          ...
          <div class="section-card">
            <div class="section-head">
              <div class="left">
                <div class="sec-ic"><i class="bi bi-card-text"></i></div>
                <div>
                  <p class="sec-title mb-0">Identity Details</p>
                  <p class="sec-sub">Aadhar / PAN and related details</p>
                </div>
              </div>
            </div>
            <div class="kv">
              <div class="kv-row"><div class="kv-k">Aadhar Card Number</div><div class="kv-v"><?php echo showVal($emp['aadhar_card_number']); ?></div></div>
              <div class="kv-row"><div class="kv-k">PAN Card Number</div><div class="kv-v"><?php echo showVal($emp['pancard_number']); ?></div></div>
            </div>
          </div>
          ...
          <div class="section-card">
            <div class="section-head">
              <div class="left">
                <div class="sec-ic"><i class="bi bi-bank"></i></div>
                <div>
                  <p class="sec-title mb-0">Banking Details</p>
                  <p class="sec-sub">Account and IFSC</p>
                </div>
              </div>
            </div>
            <div class="kv">
              <div class="kv-row"><div class="kv-k">Bank Account Number</div><div class="kv-v"><?php echo showVal($emp['bank_account_number']); ?></div></div>
              <div class="kv-row"><div class="kv-k">IFSC Code</div><div class="kv-v"><?php echo showVal($emp['ifsc_code']); ?></div></div>
              <div class="kv-row"><div class="kv-k">Passbook Photo</div><div class="kv-v"><?php echo fileLinkBtn($emp['passbook_photo'] ?? '', 'Passbook'); ?></div></div>
            </div>
          </div>
          ...
          <div class="section-card">
            <div class="section-head">
              <div class="left">
                ...
                <div>
                  <p class="sec-title mb-0">Documents</p>
                  <p class="sec-sub">Uploaded employee files</p>
                </div>
              </div>
            </div>
            <div class="kv">
              <div class="kv-row">
                <div class="kv-k">Profile Photo Path</div>
                <div class="kv-v"><?php echo showVal($emp['photo']); ?></div>
              </div>
              <div class="kv-row">
                <div class="kv-k">Profile Photo</div>
                <div class="kv-v">
                  <?php if (!empty($empPhoto)): ?>
                    <?php echo fileLinkBtn($empPhoto, 'Photo'); ?>
                  <?php else: ?>
                    —
                  <?php endif; ?>
                </div>
