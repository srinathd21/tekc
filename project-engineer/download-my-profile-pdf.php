...
// Fetch employee with reporting manager
...
// Push content below photo
$pdf->SetY(50);

// Insert photo
if (!empty($photoPath) && file_exists($photoPath)) {
    $pdf->Image($photoPath, 167, 17, 26, 26);
}
...
$pdf->Output('D', 'My_Profile_'.$emp['employee_code'].'.pdf');
exit;
?>